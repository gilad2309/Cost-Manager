...
function TopBar() {
  ...
  const titleBlock = (
    <Stack spacing={0.2}>
      <Typography variant="h5" component="div" className="top-bar__title">Cost Manager</Typography>
      <Typography variant="body2" component="div" className="top-bar__subtitle">Expense tracking and reporting</Typography>
    </Stack>
  );
  ...
  return (
    ...
    <AppBar position="sticky" elevation={0} className="top-bar">
      <Toolbar className="top-bar__toolbar">
        <Container maxWidth="lg" className="top-bar__content">{titleBlock}{metaBlock}</Container>
      </Toolbar>
    </AppBar>
  );
}
